                            ...
                            <table class="table table-bordered table-striped table-hover">
                                <thead class="bg-primary text-white">
                                    <tr>
                                        ...
                                        <th scope="col">Primary Sport</th>
                                        <th scope="col">Skills Level</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src='../upload/<?php echo $data['profilePicture']; ?>'
                                                style="width:75px;" />
                                        </td>
                                        ...
                                        <td>
                                            <?php echo $data['primarySport']; ?>
                                        </td>

                                        <td><?php echo $data['skillLevel']; ?></td>
                                        <td><?php echo $data['favoriteSports']; ?></td>
                                        <td><?php echo $data['activeDays']; ?></td>
